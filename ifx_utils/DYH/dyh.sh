...
#./ndyh.py --bid BID264 --user bridges@continuumbridge.com --db Bridges --password Mucht00f@r --to "Megan.Whiteley@thedtgroup.org" --mail "y" --doors "" --writetoifx "" --warning_mails "" --daysago 0
