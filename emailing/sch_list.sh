...
# CBr
date
./ifx_CBr_mail.py --user bridges@continuumbridge.com --password Mucht00f@r --bid BID66 --db "Bridges" --template "CBr_table_template.htm" --to "martin.sotheran@continuumbridge.com, peter.claydon@continuumbridge.com, Praminda.Caleb-solly@uwe.ac.uk"

date
./friendly_CBr_mail.py --user bridges@continuumbridge.com --password Mucht00f@r --bid BID241 --db "Bridges" --template "CBr_table_template.htm" --to "martin.sotheran@continuumbridge.com, peter.claydon@continuumbridge.com, steve.barraclough@continuumbridge.com"
...
# Sirona
date
./friendly_CBr_mail.py --user bridges@continuumbridge.com --password Mucht00f@r --bid BID36 --db "SCH" --template Sirona_table_template.htm --to "martin.sotheran@continuumbridge.com, peter.claydon@continuumbridge.com, martyn.price@sirona-cic.org.uk"
date
