...
#, richard.tarring@sirona-cic.org.uk" Off 'till we switch to geras & have Sirona branding working
# CBr
...
date
./ifx_CBr_mail.py --user bridges@continuumbridge.com --password Mucht00f@r --bid BID11 --db "Bridges" --to "martin.sotheran@continuumbridge.com, peter.claydon@continuumbridge.com" --template "CBr_table_template.htm"
date
...
date
./ifx_CBr_mail.py --user bridges@continuumbridge.com --password Mucht00f@r --bid BID67 --db "SCH" --to "martin.sotheran@continuumbridge.com, peter.claydon@continuumbridge.com" --template "CBr_table_template.htm"
