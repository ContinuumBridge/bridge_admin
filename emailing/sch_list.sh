...
# Sirona
#date
# waste of space for now
#./sch_mail.py --user bridges@continuumbridge.com --password cbridgest00f@r --key b9b0c3fea6308127164de1616cb97723 --bid BID44 --to "peter.claydon@continuumbridge.com, martin.sotheran@continuumbridge.com"
date
...
date
./CBr_mailBW.py --user bridges@continuumbridge.com --password cbridgest00f@r --key b9b0c3fea6308127164de1616cb97723 --bid BID59 --to "peter.claydon@continuumbridge.com, martin.sotheran@continuumbridge.com"
